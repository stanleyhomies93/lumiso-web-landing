...
export default function Footer() {
  return (
    <footer className="bg-accent/5 pt-16 pb-8">
      <div className="container px-4 mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          {/* Company info */}
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-4">
              <div className="p-1 bg-brand rounded-md text-brand-foreground">
                <Coffee className="h-5 w-5" />
              </div>
              <span className="font-bold text-xl">Lumiso</span>
            </Link>
            <p className="text-foreground/70 mb-6 max-w-md">
              We create digital solutions that help businesses 
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <span className="text-foreground/70">
                  123 Innovation Drive, Tech Hub<br />
        ...
        <div className="border-t border-gray-200 dark:border-gray-800/50 pt-8 flex flex-col md:flex-row justify-between items-center">
